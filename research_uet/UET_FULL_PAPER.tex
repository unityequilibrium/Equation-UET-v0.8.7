...
\title{Unified Equilibrium Theory (UET): The Thermodynamic Cost of Information Processing as the Determinant of Physical Law}
...
We analyzed 175 galaxies from the SPARC database \cite{lelli_2016}. As shown in Figure \ref{fig:galaxy}, the UET prediction (Solid Line) matches the observed flat rotation curves (Dots) without requiring any Dark Matter halo component. 
\begin{figure}[h]
...
\begin{itemize}
    \item **Mass**: Derived as $\approx 0$ (Pure Address).
    \item **Mixing**: Predicted Maximal Mixing ($\theta_{23} \approx 45^\circ$) based on diagonal projection.
\end{itemize}
