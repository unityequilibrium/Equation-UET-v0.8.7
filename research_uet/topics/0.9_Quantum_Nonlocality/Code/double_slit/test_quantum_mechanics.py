...
# Find Data folder relative to this test
_test_dir = Path(__file__).parent
_solution_dir = _test_dir.parent.parent.parent
_data_dir = _solution_dir / "Data" / "bell_inequality"

# Try to import from local Data folder
try:
    sys.path.insert(0, str(_data_dir))
    from quantum_experimental_data import (
        BELL_TEST_DATA,
        CHSH_BOUNDS,
        PLANCK_CONSTANT,
        FINE_STRUCTURE,
    ...
    # Fallback inline data with DOIs
    BELL_TEST_DATA = {
        "Aspect_1982": {"S_value": 2.697, "error": 0.015, "doi": "10.1103/PhysRevLett.49.1804"},
        "Hensen_2015": {"S_value": 2.42, "error": 0.20, "doi": "10.1038/nature15759"},
        "Giustina_2015": {"S_value": 2.38, "error": 0.02, "doi": "10.1103/PhysRevLett.115.250401"},
    }
    CHSH_BOUNDS = {"classical_limit": 2.0, "tsirelson_bound": 2.8284}
    PLANCK_CONSTANT = {"hbar": {"value": 1.054571817e-34}}
    FINE_STRUCTURE = {"alpha": {"value": 7.2973525693e-3, "inverse": 137.035999084}}
