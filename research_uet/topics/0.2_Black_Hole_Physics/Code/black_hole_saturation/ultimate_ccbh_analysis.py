...
# Fix Path to Repo Root (6 parents up from here)
# .../topics/0.2_Black_Hole/Code/black_hole_saturation/script.py
...
try:
    ...
    # Fallback/Mock constants if utility module missing
    c = 299792458
    G = 6.674e-11
    M_sun = 1.989e30
    Mpc = 3.086e22
...
def load_shen_catalog():
    ...
    # Path: .../0.2_Black_Hole/Data/black_holes_eht/shen2011_recovered.fits
    # Current: .../Code/black_hole_saturation
    path = SCRIPT_DIR.parent.parent / "Data" / "black_holes_eht" / "shen2011_recovered.fits"
...
def load_kormendy_ho():
    ...
    # Path: .../Data/black_holes_eht/kormendy_ho_data/kormendy_ho_ellipticals_sample.csv
    path = (
...
def analyze_entropy_recycling(k_fit, log_M0_avg=8.5, volume_radius_mpc=1000):
    ...
    try:
        ...
        fig.add_trace(
            uet_viz.go.Scatter(x=areas, y=entropy_hawk, name="Hawking", line=dict(dash="dash"))
        )
        fig.add_trace(
            uet_viz.go.Scatter(
        ...
        fig.update_layout(
            title="Black Hole Entropy Saturation", xaxis_title="Area", yaxis_title="Entropy"
        )
